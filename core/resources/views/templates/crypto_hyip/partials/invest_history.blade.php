                ...
                <td>
                    <div class="action--btns">
                        @if ($invest->eligibleCapitalBack())
                            <button class="btn btn-outline--success btn--sm manageCapital" data-id="{{ $invest->id }}">
                                <i class="fas fa-hand-holding-usd"></i>
                            </button>
                        @endif
                        <a href="{{ route('user.invest.details', encrypt($invest->id)) }}" class="btn btn-outline--base btn--sm">
            ...
            <form action="{{ route('user.invest.capital.manage') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="capital" class="form--control select2" data-minimum-results-for-search="-1" required>
