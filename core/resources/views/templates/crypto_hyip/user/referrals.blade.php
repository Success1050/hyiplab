    ...
    <div class="card custom--card">
        <div class="card-body">
            @if (auth()->user()->referrer)
                <h4 class="mb-4">@lang('You are referred by') {{ auth()->user()->referrer->fullname }}</h4>
            @endif
            <div class="col-md-12 mb-4">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-text input-style copytext copyBoard" id="copyBoard"> <i class="fa fa-copy"></i>
                    </span>
                </div>
            </div>
