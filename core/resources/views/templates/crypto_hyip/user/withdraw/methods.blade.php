    ...
    <div class="row justify-content-center">
        <div class="col-xxl-8 col-xl-12">
            ...
            <form action="{{ route('user.withdraw.money') }}" method="post" class="withdraw-form">
                @csrf
                <div
                    class="gateway-card custom--card @if ($isHoliday && !gs('holiday_withdraw')) custom--card card countdown-card @endif">
                                ...
                                <div class="payment-system-list is-scrollable gateway-option-list">
                                    @foreach ($withdrawMethod as $data)
                                        <label for="{{ titleToKey($data->name) }}"
                                            class="payment-item @if ($loop->index > 4) d-none @endif gateway-option form--label">
                                    ...
                                    <div class="deposit-info">
                                        ...
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                ...
                                                <input type="text" class="form--control form-control form-two amount"
