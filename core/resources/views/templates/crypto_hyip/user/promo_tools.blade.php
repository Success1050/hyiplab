                    ...
                    <div class="referral-form card-body">
                        ...
                        @php
                            $string =
                                ...
                                getImage(fileManager()->promotions()->path . '/' . @$banner->banner) .
                                '" alt="image"/></a>';
                        @endphp
                        ...
                        <button type="button" data-copytarget="#reflink{{ $banner->id }}"
                            class="btn btn--base justify-content-center w-100 mt-3 copybtn btn-block"><i
