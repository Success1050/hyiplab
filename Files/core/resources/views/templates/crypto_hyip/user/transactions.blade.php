    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="show-filter mb-3 text-end">
                <button type="button" class="btn btn--base w-100  showFilterBtn"><i class="las la-filter"></i>
                    @lang('Filter')</button>
            </div>
                    ...
                    <form>
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <select name="wallet_type" class="form--control form-two form-select select2"
                            ...
                            <div class="flex-grow-1">
                                ...
                                <select name="trx_type" class="form--control form-two form-select select2"
                                    data-minimum-results-for-search="-1">
                                    <option value="">@lang('All')</option>
...
@push('style')
    <style>
        .responsive-filter-card form>div .align-self-end {
            min-width: 190px;
        }

        @media (max-width: 424px) {
            .responsive-filter-card form>div {
