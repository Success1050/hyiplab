            ...
            <div class="card custom--card">
                ...
                <div class="card-body">
                    ...
                    <form role="form" class="disableSubmission appPayment" id="payment-form" method="{{ $data->method }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form--control form-two" name="name"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="tel" class="form-control form--control form-two" name="cardNumber"
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <label class="form--label required">@lang('Expiration Date')</label>
                                <input type="tel" class="form--control form-two" name="cardExpiry"
                                    value="{{ old('cardExpiry') }}" autocomplete="off" required />
                            </div>
                            <div class="col-md-6 ">
                                <label class="form--label required">@lang('CVC Code')</label>
                                <input type="tel" class="form--control form-two" name="cardCVC"
